...
export const RESOURCE_MAP: Record<string, ResourceConfig> = {
  ...
  "audit-programs": { table: "audit_programs", module: "reports" },
  "audit-findings": { table: "audit_findings", module: "reports" },
  compliance: { table: "compliance", module: "reports" },
  "legal-requirements": { table: "legal_requirements", module: "reports" },
  "compliance-evidence": { table: "compliance_evidence", module: "reports" },
  ...
  "hse-workflows": { table: "hse_workflows", module: "reports" },
  "hse-workflow-links": { table: "hse_workflow_links", module: "reports" },
  "hse-workflow-events": { table: "hse_workflow_events", module: "reports" },
