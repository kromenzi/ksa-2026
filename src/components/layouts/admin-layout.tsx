  ...
  const navGroups: NavGroup[] = [
...

    {
      ...
      items: [
        ...
        { label: isAr ? 'خريطة المنشأة' : 'Facility Map', icon: MapPin, href: "/admin/vision/map", visible: true, color: "text-indigo-500", bgColor: "bg-indigo-500/10" },
    ...
    },
    {
      ...
      items: [
        ...
        { label: isAr ? 'مركز استيراد البيانات' : 'Data Import Center', icon: FileSpreadsheet, href: "/admin/import-center", visible: true, color: "text-sky-600", bgColor: "bg-sky-600/10" },
    ...
    {
      title: "HSE Escalation Management",
      titleAr: "إدارة تصعيدات السلامة",
      items: [
        { label: isAr ? 'لوحة تصعيدات السلامة' : 'HSE Escalation Dashboard', icon: LayoutDashboard, href: "/admin/escalations", visible: true, color: "text-rose-500", bgColor: "bg-rose-500/10" },
        { label: isAr ? 'سجل تصعيدات السلامة' : 'Escalation Register', icon: History, href: "/admin/escalations/history", visible: true, color: "text-orange-500", bgColor: "bg-orange-500/10" },
        { label: isAr ? 'مصفوفة تصعيدات السلامة' : 'Escalation Matrix', icon: Grid, href: "/admin/escalations/matrix", visible: true, color: "text-indigo-500", bgColor: "bg-indigo-500/10" },
      ]
    },
    {
      ...
      items: [
        ...
        { label: isAr ? 'عزل مصادر الطاقة (LOTO)' : 'Lockout/Tagout (LOTO)', icon: Lock, href: "/admin/loto", visible: true, color: "text-rose-600", bgColor: "bg-rose-600/10" },
        { label: isAr ? 'نظام تصاريح العمل (PTW)' : 'Permit-to-Work (PTW)', icon: FileCheck2, href: "/admin/permits", visible: hasPermission('documents', 'read') || hasPermission('reports', 'read'), color: "text-sky-500", bgColor: "bg-sky-500/10" },
      ]
    },
    {
      title: "Licenses, Competency & Authorizations",
      titleAr: "التراخيص والكفاءة والتفويضات",
      items: [
        { label: isAr ? 'نظرة عامة على التراخيص والتفويضات' : 'Authorization Overview', icon: LayoutDashboard, href: "/admin/licenses", visible: true, color: "text-blue-500", bgColor: "bg-blue-500/10" },
        ...
        {
          label: isAr ? 'تفويضات التشغيل والعمل' : 'Operational Authorizations',
          icon: ShieldCheck, href: "/admin/equipment-auth", visible: true, color: "text-emerald-500", bgColor: "bg-emerald-500/10",
          children: [
            { label: isAr ? 'سجل التفويضات' : 'Authorization Register', icon: ShieldCheck, href: "/admin/equipment-auth", visible: true, color: "text-emerald-500", bgColor: "bg-emerald-500/10" },
            { label: isAr ? 'تشغيل الرافعات الشوكية' : 'Forklift Operation', icon: Truck, href: "/admin/equipment-auth", visible: true, color: "text-blue-600", bgColor: "bg-blue-600/10" },
            { label: isAr ? 'تشغيل الرافعات العلوية' : 'Overhead Crane Operation', icon: Wrench, href: "/admin/equipment-auth", visible: true, color: "text-orange-500", bgColor: "bg-orange-500/10" },
            { label: isAr ? 'تشغيل منصات رفع الأفراد (Manlift)' : 'Personnel Lift / Manlift Operation', icon: Activity, href: "/admin/equipment-auth", visible: true, color: "text-purple-500", bgColor: "bg-purple-500/10" },
            { label: isAr ? 'منصات العمل المرتفعة المتنقلة (MEWP)' : 'Mobile Elevating Work Platforms (MEWP)', icon: Truck, href: "/admin/equipment-auth", visible: true, color: "text-cyan-500", bgColor: "bg-cyan-500/10" },
            { label: isAr ? 'أعمال الربط والتوجيه والإشارات' : 'Rigging & Banksman / Signalman', icon: Award, href: "/admin/equipment-auth", visible: true, color: "text-amber-600", bgColor: "bg-amber-600/10" },
            { label: isAr ? 'تفويض الأعمال الكهربائية' : 'Electrical Work Authorization', icon: Zap, href: "/admin/equipment-auth", visible: true, color: "text-yellow-500", bgColor: "bg-yellow-500/10" },
            { label: isAr ? 'تفويض عزل مصادر الطاقة (LOTO)' : 'LOTO Authorization', icon: Lock, href: "/admin/equipment-auth", visible: true, color: "text-rose-600", bgColor: "bg-rose-600/10" },
            { label: isAr ? 'تفويض العمل على الارتفاعات' : 'Work at Height Authorization', icon: ShieldAlert, href: "/admin/equipment-auth", visible: true, color: "text-sky-600", bgColor: "bg-sky-600/10" },
            { label: isAr ? 'تفويض دخول الأماكن المحصورة' : 'Confined Space Entry Authorization', icon: AlertTriangle, href: "/admin/equipment-auth", visible: true, color: "text-red-500", bgColor: "bg-red-500/10" },
          ]
        },
    ...
    {
      title: "HSE Reports & Documents",
      titleAr: "تقارير ومستندات HSE",
      items: [
        { label: isAr ? 'مستندات وسجلات السلامة' : 'HSE Documents & Records', icon: FileArchive, href: "/admin/files", visible: true, color: "text-blue-500", bgColor: "bg-blue-500/10" },
        { label: isAr ? 'لوحات وإشارات السلامة' : 'Safety Signs', icon: ShieldAlert, href: "/admin/reports-documents/safety-signs", visible: true, color: "text-amber-500", bgColor: "bg-amber-500/10" },
        { label: isAr ? 'تقارير HSE الموحدة (300 DPI)' : 'Standardized HSE Reports (300 DPI)', icon: FileText, href: "/admin/enterprise-reports", visible: true, color: "text-slate-400", bgColor: "bg-slate-500/10" },
    ...
    {
      title: "Safety Communication & Culture",
      titleAr: "اتصالات وثقافة السلامة",
      items: [
        ...
        { label: isAr ? 'الأقسام' : 'Departments', icon: Boxes, href: "/admin/sections", visible: hasPermission('sections', 'read'), color: "text-violet-500", bgColor: "bg-violet-500/10" },
        { label: isAr ? 'منشورات وتوعية السلامة' : 'Safety Communications & Posts', icon: Newspaper, href: "/admin/posts", visible: hasPermission('content', 'read'), color: "text-sky-500", bgColor: "bg-sky-500/10" },
        { label: isAr ? 'صندوق وارد HSE' : 'HSE Inbox', icon: Inbox, href: "/admin/inbound-inbox", visible: hasPermission('settings', 'read'), color: "text-fuchsia-500", bgColor: "bg-fuchsia-500/10" },
        ...
        { label: isAr ? 'قواعد تنبيهات HSE' : 'HSE Alert Rules', icon: MessagesSquare, href: "/admin/notification-rules", visible: hasPermission('settings', 'read'), color: "text-yellow-500", bgColor: "bg-yellow-500/10" },
      ]
    },
    {
