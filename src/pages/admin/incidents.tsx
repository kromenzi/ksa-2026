...
export default function AdminIncidentsPage() {
  ...
  const printIncident = () => {
    ...
    const report = document.querySelector<HTMLElement>(".incident-print-report");
    ...
    const printStyles = `
      ...
      * { box-sizing:border-box; }
      ...
      .incident-print-report { display:block !important; width:100%; direction:${isAr ? "rtl" : "ltr"}; text-align:${isAr ? "right" : "left"}; color:#111827 !important; background:#fff !important; }
      .incident-print-page { width:100%; }
      ...
      .incident-print-header-title { background:#b91c1c !important; color:#fff !important; padding:12px 14px; font-size:18px; font-weight:800; box-shadow:inset 0 0 0 1000px #b91c1c; }
      .incident-print-header-subtitle { padding:7px 14px; background:#fef2f2 !important; color:#7f1d1d !important; font-size:10px; box-shadow:inset 0 0 0 1000px #fef2f2; }
      ...
      .incident-print-section-title { background:#1f2937 !important; color:#fff !important; padding:7px 9px; border-radius:5px; font-size:11px; font-weight:800; margin-bottom:7px; box-shadow:inset 0 0 0 1000px #1f2937; }
      ...
      .incident-print-table th { background:#f3f4f6 !important; font-weight:700; box-shadow:inset 0 0 0 1000px #f3f4f6; }
      ...
      @media print { html,body { background:#fff !important; color:#111827 !important; } }
    `;

    const html = `<!doctype html><html lang="${isAr ? "ar" : "en"}" dir="${isAr ? "rtl" : "ltr"}"><head><meta charset="utf-8"><title>${esc(activeIncident.refNo)} - Incident Report</title><style>${printStyles}</style></head><body>${report.outerHTML}<script>window.addEventListener('load',function(){setTimeout(function(){window.focus();window.print();},300);});</script></body></html>`;
  ...
  return (
    <div className="space-y-6" data-testid="admin-incidents-page">
      <style>{`@page{size:A4;margin:12mm}.incident-print-report{display:none;direction:ltr;color:#111827;background:#fff;font-family:Arial,Helvetica,sans-serif;forced-color-adjust:none;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}.incident-print-report[dir="rtl"]{direction:rtl;text-align:right}@media print{html,body{background:#fff!important;color:#111827!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}body *{visibility:hidden!important}.incident-print-report,.incident-print-report *{visibility:visible!important}.incident-print-report{display:block!important;position:absolute!important;inset:0!important;width:100%!important;margin:0!important;padding:0!important;box-sizing:border-box!important}.incident-print-report *{forced-color-adjust:none!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}.incident-print-page{width:100%;box-sizing:border-box}.incident-print-section{break-inside:avoid;page-break-inside:avoid;margin-bottom:14px}.incident-print-table{width:100%;border-collapse:collapse;table-layout:fixed}.incident-print-table th,.incident-print-table td{border:1px solid #d1d5db;padding:7px 8px;vertical-align:top;font-size:10px;line-height:1.45}.incident-print-table th{background:#f3f4f6!important;box-shadow:inset 0 0 0 1000px #f3f4f6;font-weight:700}.incident-print-card{border:1px solid #d1d5db;border-radius:7px;padding:10px;background:#fff!important}.incident-print-badge{display:inline-block;padding:3px 8px;border-radius:999px;font-size:9px;font-weight:700;line-height:1.2;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}.incident-print-header{border:2px solid #b91c1c;border-radius:9px;overflow:hidden;margin-bottom:12px}.incident-print-header-title{background:#b91c1c!important;box-shadow:inset 0 0 0 1000px #b91c1c;color:#fff!important;padding:12px 14px;font-size:18px;font-weight:800}.incident-print-header-subtitle{padding:7px 14px;background:#fef2f2!important;box-shadow:inset 0 0 0 1000px #fef2f2;color:#7f1d1d!important;font-size:10px}.incident-print-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.incident-print-label{display:block;color:#6b7280!important;font-size:8px;font-weight:700;text-transform:uppercase;margin-bottom:2px}.incident-print-value{font-size:10px;font-weight:600}.incident-print-title{color:#991b1b!important;font-size:13px;font-weight:800;margin:0 0 7px}.incident-print-section-title{background:#1f2937!important;box-shadow:inset 0 0 0 1000px #1f2937;color:#fff!important;padding:7px 9px;border-radius:5px;font-size:11px;font-weight:800;margin-bottom:7px}.incident-print-why{border:1px solid #bfdbfe;border-radius:6px;padding:7px;margin-bottom:6px;background:#eff6ff!important;box-shadow:inset 0 0 0 1000px #eff6ff}.incident-print-why strong{color:#1d4ed8!important}.incident-print-fishbone{border:1px solid #ddd6fe;border-radius:6px;padding:7px;margin-bottom:6px;background:#f5f3ff!important;box-shadow:inset 0 0 0 1000px #f5f3ff}.incident-print-action-open{background:#fff7ed!important;box-shadow:inset 0 0 0 1000px #fff7ed}.incident-print-action-closed{background:#f0fdf4!important;box-shadow:inset 0 0 0 1000px #f0fdf4}.incident-print-footer{border-top:1px solid #d1d5db;margin-top:14px;padding-top:6px;font-size:8px;color:#6b7280!important;display:flex;justify-content:space-between;gap:10px}}`}</style>
